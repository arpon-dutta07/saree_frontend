...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full bg-[#FAF6F0] text-[#1E0409] overflow-hidden select-none border-t border-[#E5DACB]">
      {/* 1. Subtle Textured Parchment Backdrop */}
      <div className="absolute inset-0 pointer-events-none opacity-35 mix-blend-multiply z-0">
        <Image
        ...
        <div className="max-w-[1440px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-8">
          <div className="text-center lg:text-left space-y-2 max-w-xl">
            ...
            <h3 className="font-serif text-[clamp(24px,2.4vw,34px)] font-normal text-[#1E0409] leading-snug">
              Receive private salon viewings, seasonal lookbooks &amp; <span className="italic font-light text-[#8B1E3F]">bridal invitations</span>.
            </h3>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <span className="font-sans text-[8.5px] font-semibold tracking-[0.38em] text-[#8B1E3F] uppercase">
                  Haute Couture
                </span>
              </div>
            </div>
            ...
            <div className="pt-1 space-y-1.5 text-xs text-[#7A6458] font-sans">
              <p>Atelier Concierge: <a href="mailto:concierge@aarohisarees.com" className="font-medium text-[#1E0409] hover:text-[#8B1E3F] transition-colors">concierge@aarohisarees.com</a></p>
              <p>Direct Line: <a href="tel:+919876543210" className="font-medium text-[#1E0409] hover:text-[#8B1E3F] transition-colors">+91 98765 43210</a></p>
            </div>
          </div>
          ...
          <div className="lg:col-span-3 space-y-5">
            ...
            <ul className="space-y-3 font-serif text-[16px] text-[#1E0409]/85">
              <li><a href="#sarees" className="hover:text-[#8B1E3F] transition-colors">Heritage Raw Silks</a></li>
              <li><a href="#sarees" className="hover:text-[#8B1E3F] transition-colors">Royal Banarasi Zari</a></li>
              <li><a href="#sarees" className="hover:text-[#8B1E3F] transition-colors">Kanjeevaram Gold Drapes</a></li>
              <li><a href="#sarees" className="hover:text-[#8B1E3F] transition-colors">Hand-Painted Organza</a></li>
              <li><a href="#new-arrivals" className="hover:text-[#8B1E3F] transition-colors">Festive &amp; Bridal Edit</a></li>
              <li><a href="#sarees" className="hover:text-[#8B1E3F] transition-colors">Bespoke Trousseau</a></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <ul className="space-y-3 font-serif text-[16px] text-[#1E0409]/85">
              <li><a href="#heritage" className="hover:text-[#8B1E3F] transition-colors">Our Heritage</a></li>
              <li><a href="#heritage" className="hover:text-[#8B1E3F] transition-colors">Master Weavers</a></li>
              <li><a href="#heritage" className="hover:text-[#8B1E3F] transition-colors">Handloom Seal</a></li>
              <li><a href="#heritage" className="hover:text-[#8B1E3F] transition-colors">Textile Care</a></li>
              <li><a href="#heritage" className="hover:text-[#8B1E3F] transition-colors">Sustainability</a></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-3 space-y-5">
            ...
            <div className="space-y-4 font-sans text-xs text-[#5E4A3F]">
              <div>
                ...
                <p className="text-[#8B1E3F] text-[11px] font-semibold mt-0.5">By Private Appointment</p>
              </div>
              ...
              <div>
                ...
                <p className="text-[#8B1E3F] text-[11px] font-semibold mt-0.5">Walk-ins &amp; Appointments</p>
              </div>

              <div className="pt-1">
                <a
                  href="mailto:concierge@aarohisarees.com?subject=Bespoke%20Appointment%20Request"
                  className="inline-flex items-center gap-2 text-[11px] font-semibold tracking-[0.22em] uppercase text-[#4A0E17] hover:text-[#8B1E3F] transition-colors"
                >
      ...
      <div className="relative z-10 border-t border-[#E5DACB] py-7 px-6 sm:px-10 lg:px-16 text-xs text-[#7A6458] font-sans">
        <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-[#4A0E17]">
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#8B1E3F] transition-colors" aria-label="Instagram">
            ...
            <a href="https://pinterest.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#8B1E3F] transition-colors" aria-label="Pinterest">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
